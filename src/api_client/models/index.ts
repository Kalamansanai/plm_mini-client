 ...
 * @export
 */
export type LocationsGetByIdResOngoingTaskResOngoingInstance =
    LocationsGetByIdResOngoingTaskInstanceRes;
/**
 *
 * @export
 ...
 *
 * @export
 * @interface LocationsGetOngoingStatusRes
 */
export interface LocationsGetOngoingStatusRes {
    /**
     *
     * @type {boolean}
     * @memberof LocationsGetOngoingStatusRes
     */
    hasOngoingTaskInstance: boolean;
}
