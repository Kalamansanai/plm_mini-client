...
export class DetectorsApi extends runtime.BaseAPI {
    ...
    /**
     */
    async apiEndpointsDetectorsGetInitialCalibrationDataRaw(requestParameters: ApiEndpointsDetectorsGetInitialCalibrationDataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling apiEndpointsDetectorsGetInitialCalibrationData.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/detectors/{id}/getinitialcalibrationdata`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    /**
     */
    async apiEndpointsDetectorsGetInitialCalibrationData(requestParameters: ApiEndpointsDetectorsGetInitialCalibrationDataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.apiEndpointsDetectorsGetInitialCalibrationDataRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    /**
     */
    async apiEndpointsDetectorsReCalibrateRaw(requestParameters: ApiEndpointsDetectorsReCalibrateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.locationId === null || requestParameters.locationId === undefined) {
            throw new runtime.RequiredError('locationId','Required parameter requestParameters.locationId was null or undefined when calling apiEndpointsDetectorsReCalibrate.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/detectors/{locationId}/recalibrate`.replace(`{${"locationId"}}`, encodeURIComponent(String(requestParameters.locationId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    /**
     */
    async apiEndpointsDetectorsReCalibrate(requestParameters: ApiEndpointsDetectorsReCalibrateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.apiEndpointsDetectorsReCalibrateRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     */
    async apiEndpointsDetectorsRequestCalibrationPreviewRaw(requestParameters: ApiEndpointsDetectorsRequestCalibrationPreviewRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling apiEndpointsDetectorsRequestCalibrationPreview.');
        }

        if (requestParameters.newTrayPoints === null || requestParameters.newTrayPoints === undefined) {
            throw new runtime.RequiredError('newTrayPoints','Required parameter requestParameters.newTrayPoints was null or undefined when calling apiEndpointsDetectorsRequestCalibrationPreview.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/detectors/{id}/requestcalibrationpreview`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    /**
     */
    async apiEndpointsDetectorsRequestCalibrationPreview(requestParameters: ApiEndpointsDetectorsRequestCalibrationPreviewRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.apiEndpointsDetectorsRequestCalibrationPreviewRaw(requestParameters, initOverrides);
        return await response.value();
    }
